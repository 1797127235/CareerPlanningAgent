...
5. 证书：不要遗漏任何证书，包括 CET-4/6、驾驶证、普通话等级、软考等。不要按"与求职相关"过滤。
6. 知识领域：根据技能深度和项目方向推断，如"Linux系统编程""网络编程""C++系统开发""数据库"等。不要只写"编程开发"。
7. internships：只放有真实企业实习身份的经历，个人项目/课程设计不要放这里。
"""
