      ...
      >
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="p-1.5 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-lg transition-colors active:scale-[0.92] cursor-pointer"
            title="对话历史"
          >
            ...
            {sessions.length > 0 && (
              <div className="flex justify-center mb-3">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-[12px] text-slate-500 hover:text-[var(--blue)] bg-white/40 hover:bg-white/60 border border-white/50 hover:border-[var(--blue)]/20 rounded-xl transition-all active:scale-[0.97] cursor-pointer"
                >
          ...
          <div className="flex items-center justify-end px-1">
            <button
              ...
              className={`
                ...
                active:scale-[0.92]
                ${hasText
                  ? 'bg-[var(--blue)]/[0.12] text-[var(--blue)] border border-[var(--blue)]/30 hover:bg-[var(--blue)]/[0.20]'
