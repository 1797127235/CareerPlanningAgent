  ...
  return (
    <>
      ...
      <Chapter numeral="II" label="你能去哪" title="">
        ...
        <p className="mt-4 text-[length:var(--fs-body-lg)] leading-[var(--lh-body-zh)] text-[var(--ink-1)]">{dailyWhat}</p>
        <p className="mt-4 text-[length:var(--fs-body-lg)] leading-[var(--lh-body-zh)] text-[var(--ink-1)]">{notRecommended}</p>
        <p className="mt-4 text-[length:var(--fs-body-lg)] leading-[var(--lh-body-zh)] text-[var(--ink-1)]">{altText}</p>
        <div className="mt-10">
          <button
