  ...
  return (
    <section className="relative py-16 md:py-24">
      ...
      <div className="text-center">
        ...
        <p className="mt-6 font-sans text-[length:var(--fs-body-lg)] leading-[var(--lh-body-zh)] text-[var(--ink-2)] max-w-[58ch] mx-auto">
          这份报告是基于你的<strong className="text-[var(--ink-1)]">{targetLabel}</strong>
          方向履历写的。不是模板 — 每一段都在回答一个具体问题：
        </p>
        <p className="mt-4 font-sans text-[length:var(--fs-body)] leading-[var(--lh-body-zh)] text-[var(--ink-2)] max-w-[58ch] mx-auto">
